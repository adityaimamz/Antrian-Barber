                ...
                <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="/dashboard/antrian/hairCut">
                            <i class="bi bi-circle"></i><span>Hair Cut</span>
                        </a>
                    </li>
                    <li>
                        <a href="/dashboard/antrian/goodLook">
                            <i class="bi bi-circle"></i><span>Good Look</span>
                        </a>
                    </li>
                    <li>
                        <a href="/dashboard/antrian/goodMood">
                            <i class="bi bi-circle"></i><span>Good Mood</span>
                        </a>
                    </li>
                    <li>
                        <a href="/dashboard/antrian/hairEnjoy">
                            <i class="bi bi-circle"></i><span>Hair Enjoy </span>
                        </a>
                    </li>
                </ul>
            </li><!-- End Components Nav -->
